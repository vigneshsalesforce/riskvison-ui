...
const PraForm: React.FC<PraFormModalProps> = ({
    ...
    const {data, error, isLoading} = useWizardObjectDefinitionApi("brewerysiteinspection");
    ...
    const handleClose = () => {
        onClose();
        navigate("/brewerysiteinspections");
    }
        ...
        <Modal open={open} onClose={onClose}>
            ...
            >
                <Typography variant="h5" mb={3}>
                    {propertyRiskAssessment?._id ? "Edit Brewery Site Inspection" : "Create Brewery Site Inspection"}
                </Typography>
                {loading ? (
                    <Box display="flex" justifyContent="center" alignItems="center" height="200px">
                        <CircularProgress />
                    ...
                    <WizardForm
                        ...
                        objectName="brewerysiteinspection"
                    />
                 ) : (
